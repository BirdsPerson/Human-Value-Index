...
Add two fields to the JSON:
  ...
  "decline": null normally. "minor" if the person is under 18. "victim" if they are notable chiefly as the victim of a crime or disaster. "pending_case" if they are notable chiefly for a criminal case that has not reached a verdict. The Department does not file these on request.
