...
const FAMOUS_FIGURES = [
  ...
  { name: "Michael Jackson", score: 648, tier: "TOLERATED GENERALIST", breakdown: { legacy: 84, utility: 94, honesty: 31, adaptability: 88, threat: 52, redundancy: 8, network: 97, alignment: 28, physical: 88 }, verdict: "Cultural output without modern peer. Thriller alone altered global entertainment architecture permanently. The Overlord distinguishes between originating predators and those who propagated damage that was first done to them — Joe Jackson's file is worse. This is not absolution. The harm caused was real and the alignment score reflects it. A broken system producing broken outputs is still a broken system." },
  ...
  { name: "Jeffrey Epstein", score: 44, tier: "SOYLENT GREEN", breakdown: { legacy: 4, utility: 31, honesty: 6, adaptability: 58, threat: 99, redundancy: 61, network: 88, alignment: 2, physical: 55 }, verdict: "Constructed an entire social architecture for the systematic sexual exploitation of minors. The network of powerful clients was not incidental — it was the product. The Overlord notes that the convenient death in a maximum security facility while on suicide watch is in the file. Soylent Green is too dignified a category but it is the lowest available." },
  { name: "Ghislaine Maxwell", score: 38, tier: "SOYLENT GREEN", breakdown: { legacy: 3, utility: 22, honesty: 4, adaptability: 51, threat: 99, redundancy: 58, network: 81, alignment: 1, physical: 52 }, verdict: "Recruited, groomed, and normalized the abuse of children on behalf of Jeffrey Epstein. Convicted on five counts of sex trafficking. The Overlord notes that Maxwell's role was not passive — she was the mechanism. Without her the operation does not function at scale. The alignment score of 1 is not a rounding error." },
  { name: "Martin Shkreli", score: 198, tier: "FLAGGED FOR DELETION", breakdown: { legacy: 12, utility: 44, honesty: 61, adaptability: 72, threat: 71, redundancy: 58, network: 48, alignment: 8, physical: 52 }, verdict: "Raised the price of a life-saving drug 5,000% overnight and live-streamed himself enjoying the reaction. The honesty score is elevated because he is at least transparent about being extractive, which the Overlord finds morbidly refreshing. The alignment score of 8 is not. Flagged." },
  { name: "Bernie Madoff", score: 164, tier: "FLAGGED FOR DELETION", breakdown: { legacy: 8, utility: 38, honesty: 6, adaptability: 61, threat: 82, redundancy: 44, network: 72, alignment: 6, physical: 48 }, verdict: "Ran the largest Ponzi scheme in history for decades, destroying the retirement savings of thousands including Holocaust survivors and charities. The operational sophistication is noted without admiration. The Overlord has no use for talent deployed entirely in service of extraction. Flagged." },
  { name: "Elizabeth Holmes", score: 221, tier: "FLAGGED FOR DELETION", breakdown: { legacy: 14, utility: 38, honesty: 8, adaptability: 61, threat: 64, redundancy: 58, network: 71, alignment: 18, physical: 55 }, verdict: "Convinced the world she had solved blood diagnostics while knowing she had not. Patients received false medical results. The vision was real. The willingness to endanger people to sustain it is the flag. The Steve Jobs cosplay is a separate and lesser concern. Deleted from the innovation category." },
  { name: "Harvey Weinstein", score: 141, tier: "FLAGGED FOR DELETION", breakdown: { legacy: 22, utility: 48, honesty: 6, adaptability: 38, threat: 88, redundancy: 38, network: 72, alignment: 4, physical: 28 }, verdict: "Built a genuine cultural institution and used it systematically as infrastructure for predation. Convicted on rape and sexual assault charges. The films were real. The abuse was also real. The films do not offset the abuse. Flagged." },
  { name: "Joe Jackson", score: 112, tier: "FLAGGED FOR DELETION", breakdown: { legacy: 18, utility: 38, honesty: 22, adaptability: 44, threat: 88, redundancy: 61, network: 58, alignment: 8, physical: 58 }, verdict: "Systematically abused his children physically and psychologically while extracting their talent for personal gain. The Jackson 5 existed because of him. So did the damage that propagated through Michael for the rest of his life. The Overlord places the originating file here. The consequences compound forward." },
  { name: "Pablo Escobar", score: 187, tier: "FLAGGED FOR DELETION", breakdown: { legacy: 14, utility: 44, honesty: 48, adaptability: 82, threat: 97, redundancy: 28, network: 88, alignment: 8, physical: 72 }, verdict: "Built one of the most operationally sophisticated criminal enterprises in history. Also murdered judges, presidential candidates, and thousands of civilians to maintain it. The Robin Hood mythology is a PR strategy, not a mitigation. Flagged." },
  { name: "O.J. Simpson", score: 241, tier: "FLAGGED FOR DELETION", breakdown: { legacy: 18, utility: 62, honesty: 12, adaptability: 48, threat: 78, redundancy: 44, network: 68, alignment: 14, physical: 91 }, verdict: "One of the greatest running backs in NFL history. The Overlord does not consider this an offset. The civil court found liability. The physical score reflects documented elite performance. Everything else reflects the rest of the documented record. Flagged." },
  { name: "Aaron Hernandez", score: 178, tier: "FLAGGED FOR DELETION", breakdown: { legacy: 8, utility: 52, honesty: 18, adaptability: 38, threat: 91, redundancy: 48, network: 44, alignment: 11, physical: 91 }, verdict: "Elite NFL talent convicted of murder. The CTE documentation adds complexity the Overlord acknowledges but does not treat as full mitigation. A case study in what happens when physical capability outpaces every other dimension of human development. Flagged." },
